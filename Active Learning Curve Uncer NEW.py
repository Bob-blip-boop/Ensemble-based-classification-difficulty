...
def difficulty_sampling(base_learner, X_train, y_train, n_instances, diff_inst, X_pool, global_rand_seed, mode, n_estimators, dif_measure):
...
#for data in range(1,2):
    ...
    diff_size = .5                  #In Percentage 1 = 100%
    initial_train_size = 0.05   #In Percentage 0.001 = .1%
    n_estimators = 300
    ...
    for global_rand_seed in seeds:
        ...
        for i in range(n, len(X_pool), n):
            ...
            #Clf Cnt Sampling 
            start = timeit.default_timer()
            clf_cnt_indx, adatime = difficulty_sampling(clf_cnt_learner, clf_cnt_X_train, clf_cnt_y_train, n, diff_perc, clf_cnt_X_pool, 
            ...
            #f Sampling 
            f_indx = difficulty_sampling(f_learner, f_X_train, f_y_train, n, diff_perc, f_X_pool, 
            ...
            #Ind Err Sampling 
            ind_err_indx = difficulty_sampling(ind_err_learner, ind_err_X_train, ind_err_y_train, n, diff_perc, ind_err_X_pool, 
